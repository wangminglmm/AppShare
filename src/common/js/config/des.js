import {_APP_DES_KEY_} from './config.js'

var DES_PARVAT = (function() {
...
var Des = (function(a, b) {
	var desArr = _APP_DES_KEY_,
		des = {};
	des.enc = function(n) {
		var arr = [n];
		arr.push.apply(arr, desArr);
		return a.apply(des, arr);
	};
	des.dec = function(n) {
		if(/^http/.test(n)) {
			return n;
		...
		var arr = [n];
		arr.push.apply(arr, desArr);
		return b.apply(des, arr);
	};
	return des;
}(DES_PARVAT.strEnc, DES_PARVAT.strDec))
